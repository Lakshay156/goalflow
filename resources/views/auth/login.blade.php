...
<div class="w-full max-w-md animate-fade-in-up">
    <div class="glass-card-static rounded-3xl p-8 shadow-glass-lg">
        ...
        <div class="text-center mb-8">
            ...
            <p class="text-white/50 text-sm">Sign in to continue your journey</p>
        </div>

        <!-- Social Placeholders -->
        <div class="grid grid-cols-2 gap-3 mb-6">
            <button class="btn-glass py-2.5 justify-center rounded-xl text-sm opacity-60 cursor-not-allowed" disabled>
        ...
        <div class="flex items-center gap-3 mb-6">
            ...
            <span class="text-white/30 text-xs">or continue with email</span>
            <div class="flex-1 h-px bg-white/10"></div>
        </div>
        ...
        <form method="POST" action="{{ route('login') }}" class="space-y-4">
            ...
            <div class="flex items-center gap-3">
                <input type="checkbox" name="remember" id="remember" class="ios-checkbox">
                <label for="remember" class="text-sm text-white/50 cursor-pointer">Remember me for 30 days</label>
            </div>
        ...
        <p class="text-center text-white/40 text-sm mt-6">
            No account?
            <a href="{{ route('register') }}" class="text-indigo-400 hover:text-indigo-300 transition-colors font-medium">Create one free</a>
        </p>
    </div>
</div>
</x-layouts.auth>
